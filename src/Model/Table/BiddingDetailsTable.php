...
class BiddingDetailsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->integer('qty_approved')
            ->allowEmptyString('qty_approved');
        ...
        $validator
            ->integer('reviewed_payable')
            ->allowEmptyString('reviewed_payable');

        $validator
            ->integer('qty_reviewed')
            ->allowEmptyString('qty_reviewed');
