        ...
        <table class="table table-hover text-nowrap">
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('qty_approved') ?></th>
                    <th><?= $this->Paginator->sort('price') ?></th>
                    <th><?= $this->Paginator->sort('total_payable') ?></th>
                    <th><?= $this->Paginator->sort('qty_met') ?></th>
                    <th><?= $this->Paginator->sort('approved_payable') ?></th>
                    <th><?= $this->Paginator->sort('reviewed_payable') ?></th>
                    <th><?= $this->Paginator->sort('qty_reviewed') ?></th>
            ...
            <tbody>
                <?php foreach ($biddingDetails as $biddingDetail) : ?>
                    <tr>
                        ...
                        <td><?= $this->Number->format($biddingDetail->qty_approved) ?></td>
                        <td><?= $this->Number->format($biddingDetail->price) ?></td>
                        <td><?= $this->Number->format($biddingDetail->total_payable) ?></td>
                        <td><?= $this->Number->format($biddingDetail->qty_met) ?></td>
                        <td><?= $this->Number->format($biddingDetail->approved_payable) ?></td>
                        <td><?= $this->Number->format($biddingDetail->reviewed_payable) ?></td>
                        <td><?= $this->Number->format($biddingDetail->qty_reviewed) ?></td>
